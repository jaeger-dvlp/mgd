...
function AlertPopup(): JSX.Element | null {
  ...
  return (alertPopup?.inHTML && (
    ...
    >
      <div
        className={`${popupClass} grid max-h-fit w-full max-w-md grid-cols-1 place-content-start place-items-center gap-10 border border-black bg-white p-5 shadow-xl transition-all duration-300`}
      >
        ...
        <button
          ...
          className="min-w-[90px] bg-black px-4 py-1 text-center text-sm font-medium text-white transition-all duration-150 hover:bg-black/70 disabled:pointer-events-none disabled:opacity-50"
          type="button"
